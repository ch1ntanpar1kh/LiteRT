...
# TIP: Sometimes setting env var `UV_INDEX_URL=[https://pypi.org/simple](https://pypi.org/simple)` helps
...
* **🏎️ Faster GPU Acceleration via ML Drift:** **Gen-AI Inference.** Leverage state-of-the-art GPU acceleration with new buffer interoperability that minimizes latency across various GPU buffer types.
...
*(Note: Replace with your specific package manager commands if applicable)*
...
Gradle
dependencies {
    implementation 'com.google.ai.edge:litert:latest.version'
}
```
...
[👉 Read more on the official LiteRT Developer Website](https://ai.google.dev/edge/litert)
...
* **[LiteRT Generative Torch API](https://github.com/google-ai-edge/litert-torch/tree/main/litert_torch/generative):** A library to reauthor LLMs for efficient conversion and inference.
